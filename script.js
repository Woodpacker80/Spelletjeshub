...
function updateTurnUI(){
  ...
  document.getElementById('btn-vowel').disabled=!(isP&&G.hasGuessed&&(G.phase==='spin'||G.phase==='guess')&&!G.locked&&G.roundScore.player>=(G.vowelCost||VOWEL_COST)&&hasUnrevealedVowels()&&!G.suddenDeath);
...
function handleBuyVowel(){
  if(G.turn!=='player'||!G.hasGuessed||(G.phase!=='spin'&&G.phase!=='guess')||G.locked) return;
