...
function startRound(){
  ...
  if(roundType !== 'normal'){
    ...
    if(roundType === 'gold'){
      title = '👑 Goudronde!';
      body  = 'Goudvak (+€5.000) staat naast Bankrupt. Zilvervak (+€2.500) staat ook op het rad. Één Beurt Verlies is nu een Min-vak (−50%). Klinkers kosten €500 in deze ronde!';
      icon  = '✨';
    } else {
      title = '⭐ Zilverronde!';
      body  = 'Zilvervak: land erop + raad een medeklinker goed = verdiensten + €2.500! Min-vak: verlies 50% rondeverdiensten!';
      icon  = '⚡';
    }
    setTimeout(()=>{
