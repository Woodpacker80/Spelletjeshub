  ...
  setTimeout(()=>{
    ...
    if(pct >= cfg.solve && Math.random() < cfg.solveChance){
      ...
      if(Math.random() < failChance){
        // Illusionist: toon grote popup en wissel beurt
        sndWrong();
        setTimeout(()=>showResult('Computer raadt verkeerd!', 'Jij bent weer aan de beurt!', '❌', false, ()=>switchTurn('computer')), 300); return;
      }
      setBanner('🤖 Oplossen…','money');
      setTimeout(()=>endRound('computer'), 1400); return;
    }
